...
Para instruções detalhadas sobre como configurar chaves SSH no GitHub, consulte a documentação oficial disponível [aqui](https://docs.github.com/en/authentication).
...
Para obtener instrucciones detalladas sobre cómo configurar claves SSH en GitHub, consulta la documentación oficial disponible [aquí](https://docs.github.com/en/authentication).
